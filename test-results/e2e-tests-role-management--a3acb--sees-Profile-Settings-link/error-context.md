...
- Name: e2e\tests\role-management.spec.ts >> Role-Based Access Control >> Admin View >> admin sees Profile Settings link
- Location: e2e\tests\role-management.spec.ts:28:9
