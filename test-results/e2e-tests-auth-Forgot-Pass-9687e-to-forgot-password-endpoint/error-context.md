...
- Name: e2e\tests\auth.spec.ts >> Forgot Password Page >> submits email to forgot password endpoint
- Location: e2e\tests\auth.spec.ts:147:7
...
Call log:
  - navigating to "/forgot-password", waiting until "load"
