...
- Name: e2e\tests\role-management.spec.ts >> Role-Based Access Control >> Protected Routes >> unauthenticated user redirected from /users to /login
- Location: e2e\tests\role-management.spec.ts:67:9
...
Call log:
  - navigating to "/users", waiting until "load"
