...
- Name: e2e\tests\field-config.spec.ts >> Create Field Configuration >> changing field type dropdown updates the field
- Location: e2e\tests\field-config.spec.ts:81:7
