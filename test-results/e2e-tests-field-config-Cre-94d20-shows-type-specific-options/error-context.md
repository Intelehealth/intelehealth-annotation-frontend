...
- Name: e2e\tests\field-config.spec.ts >> Create Field Configuration >> expanding Configure panel shows type-specific options
- Location: e2e\tests\field-config.spec.ts:91:7
