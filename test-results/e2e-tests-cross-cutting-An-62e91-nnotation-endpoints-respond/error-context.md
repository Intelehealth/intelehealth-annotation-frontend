...
- Name: e2e\tests\cross-cutting.spec.ts >> Annotations - Cross-Cutting >> Backend API annotation endpoints respond
- Location: e2e\tests\cross-cutting.spec.ts:347:7

# Error details

```
Error: Login failed (401): {"statusCode":401,"timestamp":"2026-07-13T14:57:40.701Z","path":"/auth/login","method":"POST","error":"Unauthorized","message":"Invalid credentials"}
```
