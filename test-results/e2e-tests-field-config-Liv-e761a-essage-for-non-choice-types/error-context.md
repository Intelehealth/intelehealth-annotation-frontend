...
- Name: e2e\tests\field-config.spec.ts >> Live Preview Tree >> shows branching available message for non-choice types
- Location: e2e\tests\field-config.spec.ts:549:7
