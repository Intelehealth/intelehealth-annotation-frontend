...
- Name: e2e\tests\field-config.spec.ts >> Create Field Configuration >> selectrange type shows start/end/step inputs
- Location: e2e\tests\field-config.spec.ts:137:7
