...
- Name: e2e\tests\repetitive-fields.spec.ts >> Repeatable Field Groups >> delete field group removes it from the list
- Location: e2e\tests\repetitive-fields.spec.ts:103:7
