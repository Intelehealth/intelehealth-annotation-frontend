...
- Name: e2e\tests\cross-cutting.spec.ts >> Users - Cross-Cutting >> Backend API lists users
- Location: e2e\tests\cross-cutting.spec.ts:137:7

# Error details

```
Error: Login failed (401): {"statusCode":401,"timestamp":"2026-07-13T15:01:03.629Z","path":"/auth/login","method":"POST","error":"Unauthorized","message":"Invalid credentials"}
```
