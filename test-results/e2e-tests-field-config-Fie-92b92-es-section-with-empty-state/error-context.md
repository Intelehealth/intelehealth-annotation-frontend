...
- Name: e2e\tests\field-config.spec.ts >> Field Config Page Rendering >> renders Select Field Types section with empty state
- Location: e2e\tests\field-config.spec.ts:51:7
