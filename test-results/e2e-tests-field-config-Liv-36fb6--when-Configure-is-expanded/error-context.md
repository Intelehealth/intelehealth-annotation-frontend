...
- Name: e2e\tests\field-config.spec.ts >> Live Preview Tree >> shows Live Workflow Tree section when Configure is expanded
- Location: e2e\tests\field-config.spec.ts:541:7
