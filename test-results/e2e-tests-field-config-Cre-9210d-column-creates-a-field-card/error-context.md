...
- Name: e2e\tests\field-config.spec.ts >> Create Field Configuration >> adding a new custom column creates a field card
- Location: e2e\tests\field-config.spec.ts:102:7
