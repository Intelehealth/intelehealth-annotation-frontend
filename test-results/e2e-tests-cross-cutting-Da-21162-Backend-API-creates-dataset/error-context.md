...
- Name: e2e\tests\cross-cutting.spec.ts >> Datasets - Cross-Cutting >> Backend API creates dataset
- Location: e2e\tests\cross-cutting.spec.ts:202:7

# Error details

```
Error: Login failed (401): {"statusCode":401,"timestamp":"2026-07-13T15:01:06.509Z","path":"/auth/login","method":"POST","error":"Unauthorized","message":"Invalid credentials"}
```
