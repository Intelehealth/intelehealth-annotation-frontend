...
- Name: e2e\tests\user-management.spec.ts >> User Management Page >> sidebar navigation to users page highlights correctly
- Location: e2e\tests\user-management.spec.ts:72:7
