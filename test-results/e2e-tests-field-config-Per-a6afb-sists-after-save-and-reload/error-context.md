...
- Name: e2e\tests\field-config.spec.ts >> Persistence & Edit >> verify field type value persists after save and reload
- Location: e2e\tests\field-config.spec.ts:194:7
