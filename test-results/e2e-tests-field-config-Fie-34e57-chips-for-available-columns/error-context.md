...
- Name: e2e\tests\field-config.spec.ts >> Field Config Page Rendering >> shows CSV column chips for available columns
- Location: e2e\tests\field-config.spec.ts:57:7
