...
- Name: tests\auth.spec.ts >> Signup Mode >> shows validation errors for empty signup fields
- Location: e2e\tests\auth.spec.ts:83:7
...
Call log:
  - navigating to "http://localhost:3000/login?mode=signup", waiting until "load"
