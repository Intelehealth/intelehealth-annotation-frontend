...
- Name: tests\add-field.spec.ts >> Add New Field Feature >> add new field button is accessible on field config page
- Location: e2e\tests\add-field.spec.ts:25:7
...
Call log:
  - navigating to "http://localhost:3000/dataset/6a54c4e2f040a701bce91055", waiting until "load"
