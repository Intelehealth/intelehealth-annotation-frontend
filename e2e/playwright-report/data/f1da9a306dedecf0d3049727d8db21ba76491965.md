...
- Name: tests\repetitive-fields.spec.ts >> Repeatable Field Groups >> repeatable field groups section heading is visible
- Location: e2e\tests\repetitive-fields.spec.ts:25:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:13:07.624Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
