...
- Name: tests\user-management.spec.ts >> User Management Page >> renders the users page
- Location: e2e\tests\user-management.spec.ts:15:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:13:28.423Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
