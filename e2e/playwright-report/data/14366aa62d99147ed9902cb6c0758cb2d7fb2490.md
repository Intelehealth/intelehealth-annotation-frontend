...
- Name: tests\role-management.spec.ts >> Role-Based Access Control >> Admin View >> admin sees Dashboard link
- Location: e2e\tests\role-management.spec.ts:16:9

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:13:13.708Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
