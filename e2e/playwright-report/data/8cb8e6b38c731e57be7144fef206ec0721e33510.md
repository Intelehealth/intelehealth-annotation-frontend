...
- Name: tests\settings.spec.ts >> Dataset Settings >> settings tab is accessible from dataset detail
- Location: e2e\tests\settings.spec.ts:24:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:13:22.403Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
