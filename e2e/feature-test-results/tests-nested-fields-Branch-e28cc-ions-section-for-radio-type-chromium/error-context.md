...
- Name: tests\nested-fields.spec.ts >> Branching UI Rendering >> shows Decision Options section for radio type
- Location: e2e\tests\nested-fields.spec.ts:74:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:12:59.262Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
