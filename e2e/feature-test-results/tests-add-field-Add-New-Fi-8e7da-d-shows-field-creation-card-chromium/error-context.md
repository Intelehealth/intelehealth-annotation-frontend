...
- Name: tests\add-field.spec.ts >> Add New Field Feature >> clicking add new field shows field creation card
- Location: e2e\tests\add-field.spec.ts:30:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:00:04.934Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
