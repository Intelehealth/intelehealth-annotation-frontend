...
- Name: tests\user-management.spec.ts >> User Management Page >> shows invited users section
- Location: e2e\tests\user-management.spec.ts:21:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:13:46.143Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
