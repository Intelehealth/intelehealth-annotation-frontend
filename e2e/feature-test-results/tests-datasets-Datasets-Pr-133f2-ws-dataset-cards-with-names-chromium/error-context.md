...
- Name: tests\datasets.spec.ts >> Datasets (Projects) List Page >> shows dataset cards with names
- Location: e2e\tests\datasets.spec.ts:30:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:12:44.759Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
