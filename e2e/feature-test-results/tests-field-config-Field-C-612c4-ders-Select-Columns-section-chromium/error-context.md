...
- Name: tests\field-config.spec.ts >> Field Config Page Rendering >> renders Select Columns section
- Location: e2e\tests\field-config.spec.ts:46:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:12:51.321Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
