...
- Name: tests\annotation.spec.ts >> Annotation Workbench Access >> dataset detail page loads for authenticated admin
- Location: e2e\tests\annotation.spec.ts:24:7

# Error details

```
Error: Admin login failed (400): {"statusCode":400,"timestamp":"2026-07-13T11:00:11.539Z","path":"/auth/login","method":"POST","error":"DatabaseError","message":"Database operation failed"}
```
